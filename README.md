...
Functional CSS for cursors

## Filesize

| File | Size |
|------|------|
| `dist/cursors.css` | 6381 bytes |
| `dist/cursors.min.css` | 4585 bytes (725 Gzipped) |

## Install

```sh
npm install css-cursors
```
...
```html
<link rel="stylesheet" href="https://unpkg.com/css-cursors/dist/cursors.min.css">
```

### Direct

```html
<link rel="stylesheet" href="path/to/css-cursors/dist/cursors.min.css">
```
...
| `.cursor-auto-s` | `cursor: auto;` |
| `.cursor-default-s` | `cursor: default;` |
| `.cursor-none-s` | `cursor: none;` |
| `.cursor-context-menu-s` | `cursor: context-menu;` |
| `.cursor-help-s` | `cursor: help;` |
| `.cursor-pointer-s` | `cursor: pointer;` |
| `.cursor-progress-s` | `cursor: progress;` |
| `.cursor-wait-s` | `cursor: wait;` |
| `.cursor-cell-s` | `cursor: cell;` |
| `.cursor-crosshair-s` | `cursor: crosshair;` |
| `.cursor-text-s` | `cursor: text;` |
| `.cursor-vertical-text-s` | `cursor: vertical-text;` |
| `.cursor-alias-s` | `cursor: alias;` |
| `.cursor-copy-s` | `cursor: copy;` |
| `.cursor-move-s` | `cursor: move;` |
| `.cursor-no-drop-s` | `cursor: no-drop;` |
| `.cursor-not-allowed-s` | `cursor: not-allowed;` |
| `.cursor-e-resize-s` | `cursor: e-resize;` |
| `.cursor-n-resize-s` | `cursor: n-resize;` |
| `.cursor-ne-resize-s` | `cursor: ne-resize;` |
| `.cursor-nw-resize-s` | `cursor: nw-resize;` |
| `.cursor-se-resize-s` | `cursor: se-resize;` |
| `.cursor-sw-resize-s` | `cursor: sw-resize;` |
| `.cursor-w-resize-s` | `cursor: w-resize;` |
| `.cursor-ew-resize-s` | `cursor: ew-resize;` |
| `.cursor-s-resize-s` | `cursor: ns-resize;` |
| `.cursor-nesw-resize-s` | `cursor: nesw-resize;` |
| `.cursor-nwse-resize-s` | `cursor: nwse-resize;` |
| `.cursor-col-resize-s` | `cursor: col-resize;` |
| `.cursor-row-resize-s` | `cursor: row-resize;` |
| `.cursor-all-scroll-s` | `cursor: all-scroll;` |
| `.cursor-zoom-in-s` | `cursor: zoom-in;` |
| `.cursor-zoom-out-s` | `cursor: zoom-out;` |
...
| `.cursor-s-resize-m` | `cursor: ns-resize;` |
...
| `.cursor-s-resize-l` | `cursor: ns-resize;` |
...
Example: `.cursor-auto-m` applies the property at the medium breakpoint and above.
...
Processes `src/cursors.css` with [Lightning CSS](https://lightningcss.dev) and outputs to `dist/`.

- `dist/cursors.css` — formatted
- `dist/cursors.min.css` — minified
